...
import {initialFurniture,doors,rooms,wallRects,issues,migrateLayout} from '../dist/model.js';
import {signedDistance,distanceLabel,sameRoom,roomAt,doorRects,fixedDoorLimit,pointClear,findRoute,segmentClear,EPS} from '../dist/spatial.js';
