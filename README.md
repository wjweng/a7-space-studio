...
- 54 board finishes modelled on a supplier catalogue (colours measured, textures generated in code) can be applied to furniture's wooden parts (not sofas, whose only wood is hidden legs) and, room by room, to floors. Sofas, chairs and beds take an upholstery colour: 11 presets or any colour.
