...
export const blocksCamera=(f,eye=1.6)=>!['rug','light','beam','plant'].includes(f.type)&&(f.type==='television'?f.elevation<eye+.1&&f.elevation+f.h>eye-.2:f.h>.15&&(!['table','chair','desk'].includes(f.type)||f.h>=eye-.2));
