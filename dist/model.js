...
export const minimumsFor=f=>f?.type==='light'&&f.lightKind==='linear'?[.1,.02,.02]:minimums[f?.type];
export const linearLightDefaults={w:1.2,d:.04,h:.03};
