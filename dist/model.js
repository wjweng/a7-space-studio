...
const f=(id,type,name,x,z,w,d,h,rot=0)=>({id,type,name,x,z,w,d,h,rot,open:0,assumed:true});
export const initialFurniture=[
 f('sofa','sofa','三人沙發',2.03,1.23,2.05,.87,.84,-90),
 f('tv','console','電視矮櫃',.32,1.3,1.8,.4,.48,90),
 ...
 f('wardA','wardrobe','臥室 A 衣櫃',3.24,.53,.67,.6,2.35),
 f('deskA','desk','臥室 A 書桌',3.28,1.53,.72,.48,.75,90),
 f('bedM','bed','主臥雙人床',7.35,1.31,1.52,2,.62),
 f('wardM','wardrobe','主臥衣櫃',5.58,1.27,1.85,.6,2.35,90),
 ...
 f('kitchen','kitchen','廚具：左水槽・右爐台',5.43,6.87,2.0,.62,.9,180),
 f('fridge','fridge','冰箱（原圖左側設備位）',4.13,6.86,.55,.63,1.78,180),
