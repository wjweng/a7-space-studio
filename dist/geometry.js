...
export function furnitureInterference(a,b){if(a.type==='rug'||b.type==='rug')return false;if(a.type==='chair'&&isTableLike(b))return tableChairInterference(a,b);if(b.type==='chair'&&isTableLike(a))return tableChairInterference(b,a);return signedDistance(a,b)<-EPS;}
