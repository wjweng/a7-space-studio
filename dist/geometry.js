...
export function furnitureInterference(a,b){
 // TVs, hanging cabinets and back panels carry their underside height as `elevation`.
 const lifted=f=>['television','hangingCabinet','panel'].includes(f.type)?f.elevation||0:0,ay=lifted(a),by=lifted(b);
