...
export class SpaceScene{
 ...
 keepLampAtRealHeight(f,g){const shift=g.position.y+lightMountDrop(f,this.items||[]);for(const o of this.lightObjects||[])if(o.f===f&&o.point?.userData.baseY!==undefined){o.point.position.y=o.point.userData.baseY-shift;o.point.target.position.y=-shift;}}
