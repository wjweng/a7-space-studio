...
import {doorRects,leafWidth,fixedDoorLimit,pointClear,findRoute,roomAt,blocksCamera,cabinetLayout,cabinetRects} from './spatial.js';
export class SpaceScene{
 constructor(host,onSelect,onDrag,onDragEnd,onOperate){this.host=host;this.onSelect=onSelect;this.onDrag=onDrag;this.onDragEnd=onDragEnd;this.onOperate=onOperate;this.collisionWalls=wallRects();this.mode='orbit';this.palette='oak';this.items=[];this.groups=new Map;this.actions=new Map;this.openStates={};this.keys=new Set;this.night=false;this.lightsOn=true;this.eye=1.6;this.cutaway=true;this.selected=null;this.viewStates={};this.avoidFurniture=true;this.placing=false;doors.forEach(d=>d.maxAngle=fixedDoorLimit(d));this.route=[];
 ...
 canvas.addEventListener('pointerdown',e=>{
  ...
  const hit=this.placing?null:this.pick(e);
