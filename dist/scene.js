...
export class SpaceScene{
 ...
 this.fill=new T.DirectionalLight(0xfff4e6,1);this.fill.position.set(5,2.2,3);this.fill.castShadow=false;this.scene.add(this.fill);this.sun=new T.DirectionalLight(0xffeed8,3.1);this.sun.position.set(-3,10,-5);this.sun.castShadow=true;this.sun.shadow.mapSize.set(2048,2048);Object.assign(this.sun.shadow.camera,{left:-12,right:12,top:12,bottom:-12,near:.5,far:40});this.sun.shadow.bias=-.0004;this.sun.shadow.normalBias=.025;this.scene.add(this.sun);
